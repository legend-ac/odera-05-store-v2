  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-white/92 backdrop-blur-xl">
      <Container className="py-1.5 md:py-2">
        <div className="grid grid-cols-[1fr_auto] items-center gap-2 sm:grid-cols-[auto_1fr_auto] sm:gap-2">
          ...
          <form onSubmit={submitSearch} className="hidden sm:flex items-center gap-2 min-w-0">
        ...
        <form onSubmit={submitSearch} className="mt-1.5 flex items-center gap-2 sm:hidden">
