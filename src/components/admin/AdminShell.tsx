...
export default function AdminShell({ email, children }: { email: string; children: React.ReactNode }) {
  ...
  return (
    <div className="admin-shell min-h-dvh text-slate-950">
      <div className="admin-layout mx-auto grid gap-5 px-4 py-4 md:px-6 md:py-6 lg:grid-cols-[250px_minmax(0,1fr)]">
        <aside className="admin-sidebar h-fit p-3 lg:sticky lg:top-5">
          <div className="admin-brand mb-5 flex items-center gap-3 p-3 text-white">
            ...
            <div className="min-w-0">
              <p className="truncate text-sm font-black leading-none tracking-wide">ODERA 05</p>
              <p className="mt-1 text-[10px] font-bold uppercase tracking-[.14em] text-slate-300">Control comercial</p>
            </div>
          </div>
        ...
        <div className="flex min-w-0 flex-col gap-5">
          <header className="admin-topbar flex flex-col gap-3 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="min-w-0">
              <p className="text-[10px] font-bold uppercase tracking-[.18em] text-slate-400">Panel de administración</p>
